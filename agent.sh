...
sudo sed -i 's;Server=127.0.0.1;Server=192.168.4.5;' /etc/zabbix/zabbix_agentd.conf
sudo sed -i 's;# ListenPort=10050;ListenPort=10050;' /etc/zabbix/zabbix_agentd.conf
sudo sed -i 's;# ServerActive=;ServerActive=192.168.4.5;' /etc/zabbix/zabbix_agentd.conf
